...
function whisk_local_Message() {
    return [
        [1, "id", SendMessage, 0],
        [2, "type", "enum", 0],
    ];
}
exports.whisk_local_Message = whisk_local_Message;
