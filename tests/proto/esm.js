...
export var google_api_Http = function () { return [
    [1, "rules", ["repeated", google_api_HttpRule], 1],
    [2, "fullyDecodeReservedExpansion", "bool", 1],
]; };
export var google_api_HttpRule = function () { return [
    [1, "selector", "string", 1],
...
export var google_api_CustomHttpPattern = function () { return [
    [1, "kind", "string", 1],
    [2, "path", "string", 1],
]; };
export var google_api_HttpBody = function () { return [
    [1, "contentType", "string", 1],
    [2, "data", "bytes", 1],
    [3, "extensions", ["repeated", google_protobuf_Any], 1],
]; };
export var google_protobuf_Any = function () { return [
    [1, "typeUrl", "string", 1],
    [2, "value", "bytes", 1],
]; };
export var google_protobuf_Api = function () { return [
    [1, "name", "string", 1],
...
export var google_protobuf_Method = function () { return [
    [1, "name", "string", 1],
...
export var google_protobuf_Mixin = function () { return [
    [1, "name", "string", 1],
    [2, "root", "string", 1],
]; };
export var google_protobuf_FileDescriptorSet = function () { return [
    [1, "file", ["repeated", google_protobuf_FileDescriptorProto], 1],
]; };
export var google_protobuf_FileDescriptorProto = function () { return [
    [1, "name", "string", 0],
    [2, "package", "string", 0],
...
export var google_protobuf_DescriptorProto = function () { return [
    [1, "name", "string", 0],
...
export var google_protobuf_DescriptorProto_ExtensionRange = function () { return [
    [1, "start", "int32", 0],
    [2, "end", "int32", 0],
    [3, "options", google_protobuf_ExtensionRangeOptions, 0],
]; };
export var google_protobuf_DescriptorProto_ReservedRange = function () { return [
    [1, "start", "int32", 0],
    [2, "end", "int32", 0],
]; };
export var google_protobuf_ExtensionRangeOptions = function () { return [
...
export var google_protobuf_FieldDescriptorProto = function () { return [
    [1, "name", "string", 0],
    [3, "number", "int32", 0],
    [4, "label", "enum", 0],
    [5, "type", "enum", 0],
...
export var google_protobuf_OneofDescriptorProto = function () { return [
    [1, "name", "string", 0],
    [2, "options", google_protobuf_OneofOptions, 0],
]; };
export var google_protobuf_EnumDescriptorProto = function () { return [
    [1, "name", "string", 0],
...
export var google_protobuf_EnumDescriptorProto_EnumReservedRange = function () { return [
    [1, "start", "int32", 0],
    [2, "end", "int32", 0],
]; };
export var google_protobuf_EnumValueDescriptorProto = function () { return [
    [1, "name", "string", 0],
    [2, "number", "int32", 0],
    [3, "options", google_protobuf_EnumValueOptions, 0],
]; };
export var google_protobuf_ServiceDescriptorProto = function () { return [
    [1, "name", "string", 0],
    [2, "method", ["repeated", google_protobuf_MethodDescriptorProto], 1],
    [3, "options", google_protobuf_ServiceOptions, 0],
]; };
export var google_protobuf_MethodDescriptorProto = function () { return [
    [1, "name", "string", 0],
...
export var google_protobuf_FileOptions = function () { return [
...
export var google_protobuf_MessageOptions = function () { return [
...
export var google_protobuf_FieldOptions = function () { return [
    [1, "ctype", "enum", 0],
    [2, "packed", "bool", 0],
    [6, "jstype", "enum", 0],
    [5, "lazy", "bool", 0],
...
export var google_protobuf_OneofOptions = function () { return [
    [999, "uninterpretedOption", ["repeated", google_protobuf_UninterpretedOption], 1],
]; };
export var google_protobuf_EnumOptions = function () { return [
    [2, "allowAlias", "bool", 0],
    [3, "deprecated", "bool", 0],
    [999, "uninterpretedOption", ["repeated", google_protobuf_UninterpretedOption], 1],
]; };
export var google_protobuf_EnumValueOptions = function () { return [
    [1, "deprecated", "bool", 0],
    [999, "uninterpretedOption", ["repeated", google_protobuf_UninterpretedOption], 1],
]; };
export var google_protobuf_ServiceOptions = function () { return [
...
export var google_protobuf_MethodOptions = function () { return [
    [33, "deprecated", "bool", 0],
    [34, "idempotencyLevel", "enum", 0],
    [999, "uninterpretedOption", ["repeated", google_protobuf_UninterpretedOption], 1],
]; };
export var google_protobuf_UninterpretedOption = function () { return [
...
export var google_protobuf_UninterpretedOption_NamePart = function () { return [
    [1, "namePart", "string", 1],
    [2, "isExtension", "bool", 1],
]; };
export var google_protobuf_SourceCodeInfo = function () { return [
    [1, "location", ["repeated", google_protobuf_SourceCodeInfo_Location], 1],
]; };
export var google_protobuf_SourceCodeInfo_Location = function () { return [
...
export var google_protobuf_GeneratedCodeInfo = function () { return [
    [1, "annotation", ["repeated", google_protobuf_GeneratedCodeInfo_Annotation], 1],
]; };
export var google_protobuf_GeneratedCodeInfo_Annotation = function () { return [
    [1, "path", ["repeated", "int32"], 1],
    [2, "sourceFile", "string", 0],
    [3, "begin", "int32", 0],
    [4, "end", "int32", 0],
]; };
export var google_protobuf_Duration = function () { return [
    [1, "seconds", "int64", 1],
    [2, "nanos", "int32", 1],
]; };
export var google_protobuf_Empty = function () { return []; };
export var google_protobuf_FieldMask = function () { return [
    [1, "paths", ["repeated", "string"], 1],
]; };
export var google_protobuf_SourceContext = function () { return [
    [1, "fileName", "string", 1],
]; };
export var google_protobuf_Struct = function () { return [
    [1, "fields", ["map", "string", google_protobuf_Value], 1],
]; };
export var google_protobuf_Value = function () { return [
...
export var google_protobuf_ListValue = function () { return [
    [1, "values", ["repeated", google_protobuf_Value], 1],
]; };
export var google_protobuf_Timestamp = function () { return [
    [1, "seconds", "int64", 1],
    [2, "nanos", "int32", 1],
]; };
export var google_protobuf_Type = function () { return [
    [1, "name", "string", 1],
...
export var google_protobuf_Field = function () { return [
    [1, "kind", "enum", 0],
...
export var google_protobuf_Enum = function () { return [
    [1, "name", "string", 1],
...
export var google_protobuf_EnumValue = function () { return [
    [1, "name", "string", 1],
    [2, "number", "int32", 1],
    [3, "options", ["repeated", google_protobuf_Option], 1],
]; };
export var google_protobuf_Option = function () { return [
    [1, "name", "string", 1],
    [2, "value", google_protobuf_Any, 0],
]; };
export var google_protobuf_DoubleValue = function () { return [
    [1, "value", "double", 1],
]; };
export var google_protobuf_FloatValue = function () { return [
    [1, "value", "float", 1],
]; };
export var google_protobuf_Int64Value = function () { return [
    [1, "value", "int64", 1],
]; };
export var google_protobuf_UInt64Value = function () { return [
    [1, "value", "uint64", 1],
]; };
export var google_protobuf_Int32Value = function () { return [
    [1, "value", "int32", 1],
]; };
export var google_protobuf_UInt32Value = function () { return [
    [1, "value", "uint32", 1],
]; };
export var google_protobuf_BoolValue = function () { return [
    [1, "value", "bool", 1],
]; };
export var google_protobuf_StringValue = function () { return [
    [1, "value", "string", 1],
]; };
export var google_protobuf_BytesValue = function () { return [
    [1, "value", "bytes", 1],
]; };
...
export var whisk_api_shared_v1_Test = function () { return [
    [1, "string", "string", 1],
    [2, "uint32", "uint32", 1],
    [3, "inner", whisk_api_shared_v1_Test_Inner, 0],
    [4, "float", "float", 1],
]; };
export var whisk_api_shared_v1_Test_Inner = function () { return [
    [1, "int32", "int32", 1],
    [2, "innerInner", whisk_api_shared_v1_Inner_InnerInner, 0],
    [3, "outer", whisk_api_shared_v1_Outer, 0],
]; };
export var whisk_api_shared_v1_Inner_InnerInner = function () { return [
    [1, "long", "int64", 1],
    [2, "enum", "enum", 0],
    [3, "sint32", "sint32", 1],
]; };
export var whisk_api_shared_v1_Outer = function () { return [
    [1, "bool", ["repeated", "bool"], 1],
    [2, "double", "double", 1],
    [3, "uint32", ["repeated", "uint32"], 1],
    [4, "string", ["repeated", "string"], 1],
]; };
export var whisk_api_shared_v1_Date = function () { return [
    [1, "year", "int32", 1],
    [2, "month", "int32", 1],
    [3, "day", "int32", 1],
]; };
export var whisk_api_shared_v1_Time = function () { return [
    [1, "time", "int64", 1],
    [2, "nano", ["wrapper", "uint32"], 0],
]; };
export var whisk_api_shared_v1_Primitive = function () { return [
    [1, "double", "double", 1],
    [2, "float", "float", 1],
    [3, "int32", "int32", 1],
    [4, "int64", "int64", 1],
...
export var whisk_api_shared_v1_Big = function () { return [
    [1, "b", "int64", 1],
]; };
export var whisk_api_shared_v1_Sign = function () { return [
    [1, "b", "sint64", 1],
]; };
export var whisk_api_shared_v1_Double = function () { return [
    [1, "d", "double", 1],
]; };
export var whisk_api_shared_v1_Wrapper = function () { return [
...
export var whisk_api_user_v2_User = function () { return [
    [1, "id", "string", 1],
    [2, "email", "string", 1],
    [3, "phone", "string", 1],
...
export var whisk_api_user_v2_UserSettings = function () { return [
...
export var whisk_api_user_v2_PersonalDetails = function () { return [
...
export var whisk_api_user_v2_PersonalDetails_HealthGoals = function () { return [
...
export var whisk_api_user_v2_Height = function () { return [
    [1, "value", "double", 1],
    [2, "unit", "enum", 0],
]; };
...
export var whisk_api_user_v2_Weight = function () { return [
    [1, "value", "double", 1],
    [2, "unit", "enum", 0],
]; };
export var whisk_api_user_v2_FoodPreferences = function () { return [
    [1, "diets", "string", 1],
...
export var whisk_api_user_v2_FoodPreferences_Dates = function () { return [
    [1, "list", ["repeated", whisk_api_shared_v1_Date], 1],
]; };
export var whisk_api_user_v2_FoodPreferences_Ingredients = function () { return [
    [1, "list", ["repeated", whisk_api_user_v2_Ingredient], 1],
]; };
export var whisk_api_user_v2_CookingPreferences = function () { return [
...
export var whisk_api_user_v2_CookingPreferences_HouseholdMembers = function () { return [
    [1, "size", "int32", 1],
]; };
export var whisk_api_user_v2_CookingPreferences_CookingMaxTime = function () { return [
    [1, "time", "int32", 1],
]; };
export var whisk_api_user_v2_CookingPreferences_Devices = function () { return [
...
export var whisk_api_user_v2_Device = function () { return [
    [1, "deviceType", "enum", 0, "oneof"],
    [2, "customDevice", "enum", 0, "oneof"],
]; };
export var whisk_api_user_v2_ShoppingPreferences = function () { return [
...
export var whisk_api_user_v2_ShoppingPreferences_PreferredRetailers = function () { return [
    [1, "retailers", ["repeated", "string"], 1],
]; };
export var whisk_api_user_v2_ShoppingPreferences_EthicalPreferences = function () { return [
    [1, "list", ["repeated", "enum"], 1],
]; };
export var whisk_api_user_v2_Ingredient = function () { return [
    [1, "name", "string", 1],
    [2, "canonicalName", "string", 1],
]; };
export var whisk_api_user_v2_Recommendations = function () { return [
    [1, "dailyCalories", "int32", 1],
]; };
export var whisk_api_user_v2_TestItem = function () { return [
    [1, "id", "string", 1],
    [2, "name", "string", 1],
    [3, "surname", "string", 0],
...
export var whisk_api_user_v2_TestOneof = function () { return [
    [1, "id", "string", 1],
...
export var whisk_api_user_v2_ApiUpdateBusinessApp = function () { return [
    [1, "id", "string", 1],
    [2, "appAny", whisk_api_user_v2_TestItem, 0],
    [3, "maskAnyName", google_protobuf_FieldMask, 1],
]; };
export var whisk_api_user_v2_GetMeRequest = function () { return []; };
export var whisk_api_user_v2_GetMeResponse = function () { return [
    [1, "user", whisk_api_user_v2_User, 0],
]; };
export var whisk_api_user_v2_UpdateSettingsRequest = function () { return [
    [1, "settings", whisk_api_user_v2_UserSettings, 0],
    [2, "id", "string", 1],
    [3, "mask", google_protobuf_FieldMask, 0],
]; };
export var whisk_api_user_v2_UpdateSettingsResponse = function () { return [
    [1, "user", whisk_api_user_v2_User, 0],
]; };
export var whisk_api_user_v2_ExtractRecipeRequest = function () { return [
    [1, "url", "string", 1],
    [2, "recipeMask", google_protobuf_FieldMask, 0],
]; };
export var whisk_api_user_v2_SaveRecipeRequest = function () { return [
    [1, "recipeId", "string", 1],
    [2, "collectionIds", ["repeated", "string"], 1],
    [3, "sourceUserId", "string", 1],
    [4, "recipeMask", google_protobuf_FieldMask, 0],
]; };
export var whisk_api_user_v2_UpdateRecipeRequest = function () { return [
    [1, "recipeId", "string", 1],
    [2, "recipeMask", google_protobuf_FieldMask, 0],
...
export var whisk_api_user_v2_UpdateListRequest = function () { return [
    [1, "id", "string", 1],
    [2, "fields", whisk_api_user_v2_UpdateListRequest_Fields, 0],
    [3, "mask", google_protobuf_FieldMask, 0],
]; };
export var whisk_api_user_v2_UpdateListRequest_Fields = function () { return [
    [1, "name", "string", 1],
    [2, "primary", "bool", 1],
]; };
export var whisk_api_user_v2_UpdateItemRequest = function () { return [
    [1, "id", "string", 1],
    [2, "fields", whisk_api_user_v2_UpdateListRequest_Fields, 0],
    [3, "mask", google_protobuf_FieldMask, 0],
    [4, "newOrder", "int32", 1],
]; };
export var whisk_api_user_v2_UpdateItemRequest_Fields = function () { return [
    [1, "name", "string", 1],
    [2, "quantity", "double", 1],
    [3, "unit", "string", 1],
...
export var whisk_api_user_v2_UpdateSettingsRequestOld = function () { return [
    [1, "settings", whisk_api_user_v2_UserSettings, 0],
    [2, "mask", google_protobuf_FieldMask, 0],
]; };
export var whisk_api_user_v2_UpdateBusinessApp = function () { return [
...
export var whisk_api_user_v2_UserSettings2 = function () { return [
